...
-- current through migration 012) plus the one app_setting that only ever
-- existed inside a migration, plus the administrator account. Run this instead
-- of schema.sql followed by 001..012 — the migrations are not needed on a fresh
-- database and several of them are data moves from the old MVP system.
--
-- WHAT YOU GET
--   * All 41 tables, exactly as the current application code expects.
...
--     escalation reasons and outcomes, relationship types, and every
--     app_setting the code reads.
...
INSERT INTO care_outcome
    ...
    ('SPOKE',         'Normal — Mark complete',        1, 0, 0, NULL,        10),
    ('NEEDS_SUPPORT', 'Needs follow-up — Assign to lead', 1, 1, 0, 'STANDARD',  20),
    ('CRISIS',        'Crisis — Immediate alert',       1, 1, 0, 'EMERGENCY', 30),
    ('NO_ANSWER',     'No response — Try again in 3 days',              0, 0, 1, NULL,        40),
